					...
					<View style={{ flex: 1, paddingVertical: 24 }}>
						<FlatList
							...
							renderItem={({ item }) => (
								...
								>
									...
									<Text style={{ fontSize: 24, fontWeight: "800", color: textColor, textAlign: "center" }}>
										{item.title}
									</Text>
									<Text
										style={{
						...
						<View style={{ alignItems: "center", marginTop: 16, gap: 8 }}>
							...
							<TouchableOpacity
								...
								accessibilityLabel={activeIndex === slides.length - 1 ? t("onboarding.button.start") : t("onboarding.button.next")}
							>
								<Text style={{ color: theme.accentContrast, fontSize: 16, fontWeight: "700" }}>
									{activeIndex === slides.length - 1 ? t("onboarding.button.start") : t("onboarding.button.next")}
								</Text>
							</TouchableOpacity>
						</View>
					</View>
