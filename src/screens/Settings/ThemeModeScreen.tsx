				...
				<View style={styles.section}>
					<View style={styles.sectionCard}>
						<View style={styles.preferenceHeader}>
							...
							<Text style={styles.preferenceDescription}>라이트/다크 모드를 전환해 디스플레이 분위기를 바꿔보세요.</Text>
						</View>
								...
								return (
									...
									>
										<View style={styles.appearancePreview}>
											<View style={[styles.previewStatusBar, option.value === "dark" && styles.previewStatusBarDark]} />
											<View
												style={[
											...
											>
												<View
													style={[
														styles.previewBlock,
														option.value === "dark" ? styles.previewBlockDark : styles.previewBlockLight,
													]}
												/>
												<View
													style={[
														styles.previewBlockSmall,
														option.value === "dark" ? styles.previewBlockSmallDark : styles.previewBlockSmallLight,
													]}
												/>
											</View>
										</View>
										<Text style={[styles.appearanceLabel, isActive && styles.appearanceLabelActive]}>{option.label}</Text>
									</TouchableOpacity>
								);
							})}
						</View>
